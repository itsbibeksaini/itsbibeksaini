...
export const skill_confluence:Skill = new Skill()
...
export const skill_git:Skill = new Skill()
skill_git.TITLE = "Git"
skill_git.IMAGE = "assets/skills/others/git.png"

export const skill_githubdesktop:Skill = new Skill()
