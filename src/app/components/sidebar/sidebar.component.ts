...
import { faAddressBook, faAddressCard, faCogs, faFilePdf, faHome, faIdBadge, faImages, faLaptopCode, faLaptopHouse, faProjectDiagram } from '@fortawesome/free-solid-svg-icons';
